...
public class notification_enseignant extends AppCompatActivity {
  Button sync;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      public class Dowloader extends AsyncTask<Void, Integer, String> {
        ...
        final int utilisateur_id = sharedpref.readSharedSettingint(notification_enseignant.this, "id", 0);
