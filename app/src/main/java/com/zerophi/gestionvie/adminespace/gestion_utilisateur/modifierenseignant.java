...
public class modifierenseignant extends AppCompatActivity {
    ...
    private class CustomAdaptermodifierenseignant extends BaseAdapter {
        ...
        //    TextView txtnom = (TextView) convertView.findViewById(R.id.nomuser);
           ...
           // final String password = etudiantsmodel.getPassword();
            ...
            trashenseignant.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                      deleteDetailActivity(first_name,enseignantuser_id+" ",last_name,email);
                }
            });
         //   txtnom.setText(first_name+"  "+last_name);
            ...
            convertView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    openDetailActivity(enseignantuser_id+"",id_unique+"",
                            address,telephone,email,first_name,last_name,join_date+""/*,password*/);
        ...
        private void openDetailActivity(String ... details) {
            ...
            intent.putExtra("address",details[2]+"");
            intent.putExtra("telephone",details[3]+"");
            intent.putExtra("email",details[4]+"");
            intent.putExtra("first_name",details[5]+"");
            intent.putExtra("last_name",details[6]+"");
            intent.putExtra("join_date",details[7]+"");
          //    intent.putExtra("password",details[8]);
