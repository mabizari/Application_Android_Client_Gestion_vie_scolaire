...
public class documentsetudiantfin extends AppCompatActivity {
   private String jsonURL = Globalurls.selectmodule;//"https://gestionviescolaire.000webhostapp.com/selectmodule.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_documentsetudiantfin);
  ...
  refresh = (SwipeRefreshLayout) findViewById(R.id.swiperefreshenseignantdocument2);
myGridView  = findViewById(R.id.documentenseignantgridview2);
myProgressBar = findViewById(R.id.documentenseignantprogressbar2);
  refresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
           ...
           //     new JsonDownloader(documentsenseignants.this,enseignantuser_id,module_id).retreive(myGridView,myProgressBar);
                  new Dowloader(documentsetudiantfin.this,Globalurls.selectdocument,myGridView,module_id).execute();
