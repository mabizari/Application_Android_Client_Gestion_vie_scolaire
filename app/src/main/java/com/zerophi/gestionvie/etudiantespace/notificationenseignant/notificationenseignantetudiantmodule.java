...
public class notificationenseignantetudiantmodule extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        refresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                new Dowloader(notificationenseignantetudiantmodule.this, jsonURL, mListView).execute();
...
//Toast.makeText(Contact.this,contact.get(0).getEmail(),Toast.LENGTH_LONG).show();
 ...
 private class CustomAdaptermodules extends BaseAdapter {
        ...
        private void openSenddocuments(String module_name, int... details) {
            Intent intent = new Intent(mContext, notificationetudiantfin.class);
