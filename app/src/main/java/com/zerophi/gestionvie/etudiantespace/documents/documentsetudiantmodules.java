package com.zerophi.gestionvie.etudiantespace.documents;
...
public class documentsetudiantmodules extends AppCompatActivity {
   private String jsonURL = Globalurls.selectmodule;//"https://gestionviescolaire.000webhostapp.com/selectmodule.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String moud = getIntent().getStringExtra("enseignantuser_id");
        enseignantuser_id = Integer.parseInt(moud);
        refresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                new Dowloader(documentsetudiantmodules.this, jsonURL, mListView).execute();
...
//Toast.makeText(Contact.this,contact.get(0).getEmail(),Toast.LENGTH_LONG).show();
 ...
 private class CustomAdaptermodules extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
          ...
          //  final int utilisateur_id = sharedpref.readSharedSettingint(mContext, "id", 0);
            ...
            convertView.setOnClickListener(new View.OnClickListener() {
             ...
             openSenddocuments(module_name, module_id, semestre_id, departement_id,enseignantuser_id);
        ...
        private void openSenddocuments(String module_name, int... details) {
            Intent intent = new Intent(mContext, documentsetudiantfin.class);
            ...
            intent.putExtra("enseignantuser_id",details[3]);
